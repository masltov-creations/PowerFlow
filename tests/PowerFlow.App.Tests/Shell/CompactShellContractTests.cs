...
public sealed class CompactShellContractTests
{
    ...
    [Fact]
    public void Settings_UseNamedPowerPlanPickersAndThemePicker()
    {
        var root = FindRepoRoot();
        ...
        Assert.Contains("x:Name=\"SaverPlanBox\"", xaml, StringComparison.Ordinal);
        Assert.Contains("x:Name=\"BalancedPlanBox\"", xaml, StringComparison.Ordinal);
        Assert.Contains("x:Name=\"PerformancePlanBox\"", xaml, StringComparison.Ordinal);
        Assert.DoesNotContain("Power Saver plan GUID", xaml, StringComparison.OrdinalIgnoreCase);
        ...
        Assert.Contains("PowerPlanInfo", code, StringComparison.Ordinal);
    }
